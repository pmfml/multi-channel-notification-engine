...
import { Send, Zap, RotateCcw, AlertTriangle } from 'lucide-react';
...
export const MessageControls: React.FC = () => {
  ...
  const handleSendSingle = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const metadata: Record<string, string> = { demoDelayMs: '1000' };
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section>
        ...
        <form onSubmit={handleSendSingle} className="flex flex-col gap-3">
          <div>
